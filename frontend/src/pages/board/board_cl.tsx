       ...
       <Box sx={{  width: '100%'}}>
         <Grid container spacing={{ xs: 3, md: 3 }} columns={{ xs: 10, sm: 8, md: 10 }}>
                 {Object.keys(data).map((result:any, index:any) => (
                     <Grid xs={2} sm={2} md={6} key={index} onClick={() => goCl_info(data[result]['clno'],data[result]['cname'])}>
                         <Card style={{width:250, height:150, marginLeft: 50, marginTop:20, marginBottom: 20}}>
                             <CardActionArea>
                                 <CardContent>
                                     <Typography gutterBottom variant="h5" component="div" align="center">
